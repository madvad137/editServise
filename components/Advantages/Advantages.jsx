            ...
            <div className="advantages__inner">
                <div className="advantages__item">
                    <div className="advantages__img">
                        <img width={63} height={63} src="/ad1.png" alt="Опытные мастера"/>
                    </div>
                ...
                <div className="advantages__item">
                    <div className="advantages__img">
                        <img width={63} height={63} src="/ad1.png" alt="Склад запчастей"/>
                    </div>
                ...
                <div className="advantages__item">
                    <div className="advantages__img">
                        <img width={63} height={63} src="/ad1.png" alt="Всегда с вами"/>
                    </div>
                ...
                <div className="advantages__item">
                    <div className="advantages__img">
                        <img width={63} height={63} src="/ad1.png" alt="Доступные цены"/>
                    </div>
